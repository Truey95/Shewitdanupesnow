...
export default function ProductDetail() {
  ...
  if (!product) {
    ...
    // If we found a sample product, use it instead (DEV ONLY)
    if (sampleProduct && import.meta.env.DEV) {
      console.warn('Product not found in API, falling back to sample data (DEV ONLY)');
